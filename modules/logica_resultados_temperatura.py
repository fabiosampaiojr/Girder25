# ============================================================================
# Girder25 - logica_resultados_temperatura.py
# Autor: Fábio Henrique Sampaio Júnior
# Controlador das janelas de resultados de esforços e reações (temperatura).
# ============================================================================
...
from modules.Calculadora_Gradiente_Termico import ativar_interatividade_simples
